...
const MYSQL_DATABASE = 'robotbulls'
const MYSQL_HOST = '127.0.0.1'
const MYSQL_USER = 'root'
const MYSQL_PASSWORD = 'password'
const TABLE_NAME = [
    'activities', 'email_templates', 'global_metas', 'ico_metas', 'ico_stages', 'kycs', 'languages', 'migrations', 'pages', 'password_resets', 'payment_methods', 'referrals', 'settings', 'transactions', 'translates', 'users', 'user_metas',
    'bulls', 'client_messages', 'coin', 'wallets'
]
...
mysqlConnection.end((err) => {
    ...
    fs.writeFileSync('robotbulls.json', jsonData);
});